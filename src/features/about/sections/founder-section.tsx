					...
					<div className="space-y-9">
						<div className="flex flex-col gap-5">
							<p className="font-medium text-lg text-muted-foreground leading-relaxed">
								Vila is a certified yoga instructor and multidisciplinary
								designer based in Abu Dhabi. With a background that spans
								product design, illustration, and wellness education, she brings
								a rare combination of creativity and calm to everything she
								does.
							</p>
							<p className="text-lg text-muted-foreground leading-relaxed">
								...
								like yourself. Whether it's a group flow for women, a playful
								kids session, or a corporate workshop, Vila meets every student
