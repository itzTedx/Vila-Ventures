...
export const FeaturedProductSection = () => {
	return (
		<section className="grid grid-cols-1 gap-4 px-4 py-16 md:grid-cols-2 md:px-6">
			<div className="group relative aspect-4/3 overflow-hidden rounded-lg bg-taupe-900 p-8 text-card md:p-16">
				...
				<div className="absolute top-1/2 right-9 z-10 hidden translate-x-[20%] -translate-y-1/2 overflow-hidden rounded-md shadow-lg transition-transform duration-300 ease-out group-hover:translate-x-0 md:block">
					<Image
				...
				<LogoIcon className="absolute top-40 -right-[12%] hidden text-taupe-700/50 md:block" />
			</div>

			<div className="group relative aspect-auto overflow-hidden rounded-lg bg-primary p-8 text-card md:aspect-4/3 md:p-16">
				...
				<LogoIcon className="absolute -right-[12%] bottom-40 hidden text-orange-700/20 md:block" />
			</div>
		</section>
	);
};
